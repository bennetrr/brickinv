  ...
  return (
      <Link to={`/set/${set.id}`}>
        ...
        >
          ...
          <StackLayout padding={0.5} borderTop={{ custom: 1 }} borderColor="grey300" backgroundColor="grey50" borderRadiusBottomLeft={{custom: 'inherit'}} borderRadiusBottomRight={{custom: 'inherit'}}>
